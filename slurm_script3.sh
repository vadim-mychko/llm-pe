...
export GEMINI_API_KEY='AIzaSyDy2TS48cmK5YuRmuivUtm7HbKqwyErRUc'
...
srun /h/davaus80/.conda/envs/llm-pe/bin/python3 /h/davaus80/llm-pe/experiment_manager.py -exp_dir=/h/davaus80/llm-pe/experiments/jun_16_gem_gpt_restaurants_ts_100_items_100_users
