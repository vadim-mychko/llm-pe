...
export GEMINI_API_KEY='AIzaSyBFfgi6ivrvkqVMob42eFO3wrkCrGpLfhc'
...
srun /h/davaus80/.conda/envs/llm-pe/bin/python3 /h/davaus80/llm-pe/experiment_manager.py -exp_dir=/h/davaus80/llm-pe/experiments/jun_15_gem_gpt_mono_restaurants_100_items_100_users
