#!/bin/bash
#SBATCH --job-name=david_llm-pe_2
#SBATCH --gres=gpu:1
#SBATCH -c 2
#SBATCH --mem=10G
...
/h/davaus80/.conda/envs/llm-pe/bin/python3 /h/davaus80/llm-pe/experiment_manager.py -exp_dir=/h/davaus80/llm-pe/experiments/jan_14_mnli_temp_sweep
# wait
